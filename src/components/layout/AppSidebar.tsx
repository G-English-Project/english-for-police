      ...
      <DrawerContent className="bg-white/80 backdrop-blur-2xl border-none shadow-2xl h-full rounded-r-[3rem] w-[90vw] md:w-400px">
        <DrawerHeader className="h-16 border-b border-primary/10 flex flex-row items-center justify-between px-6">
          <div className="flex items-center gap-3 font-heading text-primary">
            ...
            <span className="font-bold tracking-tight">ENGLISH FOR POLICE</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar py-6">
          ...
          <div className="px-6 mb-8">
            <div className="mb-4 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">
            ...
            <div className="relative group">
              <Input
                ...
                className="h-12 pl-4 bg-white/50 border-primary/10 focus-visible:ring-primary/20 focus-visible:border-primary police-shadow transition-all rounded-xl text-sm"
              />
            </div>
          </div>
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isExpanded
                      ...
                      : "bg-white/40 hover:bg-white hover:shadow-md border-primary/5",
                  )}
                >
                  <div
                    className={cn(
                  ...
                  >
                    ...
                    <button
                      className="flex shrink-0 items-center justify-center px-3 text-muted-foreground transition-all hover:bg-primary/5 hover:text-primary border-l border-primary/5"
                            ...
                            <div className="space-y-1.5">
                              {category.items.map((item) => (
                                <button
                                  ...
                                  className="group flex w-full items-start gap-3 rounded-xl border border-primary/5 bg-white p-2.5 text-left transition-all hover:border-primary/30 hover:shadow-sm active:scale-[0.98]"
          ...
          <div className="px-6 py-10">
            <div className="flex items-center justify-between mb-6">
              <div className="p-0 h-auto flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">
                    ...
                    <div key={unitId} className="space-y-3 relative">
                      ...
                      <div className="space-y-2">
                        {group.phrases.map((p, i) => (
                          <div
                            key={`p-${i}`}
                            className="group p-3 rounded-2xl border border-primary/5 bg-white/60 hover:bg-white hover:border-secondary/20 hover:shadow-sm transition-all duration-300 relative overflow-hidden"
                          >
                        ...
                        {group.vocabulary.map((v, i) => (
                          <div
                            key={`v-${i}`}
                            className="group p-3 rounded-2xl border border-primary/5 bg-white/60 hover:bg-white hover:border-blue-200 hover:shadow-sm transition-all duration-300 relative overflow-hidden"
                          >
